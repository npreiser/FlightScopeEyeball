...
sensitivity = 10
# from hs  project
colorLower = np.array([0,0,250])
colorUpper = np.array([180,15,255])

# colorLower = np.array([0,0,255-sensitivity])
# colorUpper = np.array([255,sensitivity,255])
...
while True:
	...
	# NGP only look at part of the pic
	frame = frame[0:300, 0:600]
